...
export const scenarios = [
  {
    ...
    tripDates: {
      ...
      label: '12–22 ноября 2026',
      priceSeason: 'поздняя осень: спрос ниже летнего пика, бюджет 180 000 ₽ может дать больше вариантов, но море/погода требуют честного объяснения',
      selectionTrainingFocus: 'учиться объяснять сезонность Турции и не обещать летний формат отдыха по ноябрьской цене'
    },
    clientProfile: {
  ...
  },
  {
    ...
    tripDates: {
      ...
      label: '18–28 июля 2027',
      priceSeason: 'пик летнего сезона: тот же бюджет 180 000 ₽ резко ограничивает 5* и семейные отели, нужны компромиссы по датам/региону/уровню',
      selectionTrainingFocus: 'создавать подборку под высокий сезон: цена, дети, пляж и отзывы важнее красивого описания'
    },
    clientProfile: {
  ...
  },
  {
    ...
    tripDates: {
      ...
      label: '10–20 февраля 2027',
      priceSeason: 'зимний спрос: Египет продаётся как тёплое море, но цена зависит от ветра, рифа, рейса и уровня отеля',
      selectionTrainingFocus: 'сравнивать не только цену конкурента, а состав тура, риф/пляж, рейс и риски дешёвого варианта'
    },
    clientProfile: {
  ...
  },
  {
    ...
    tripDates: {
      ...
      label: '3–15 апреля 2027',
      priceSeason: 'переход к низкому сезону: цены могут быть мягче, но погода/дожди и динамика перелётов требуют отдельной проверки',
      selectionTrainingFocus: 'удерживать клиента через понятную вилку дат и объяснение, почему ждать может быть рискованно'
    },
    clientProfile: {
  ...
  },
  {
    ...
    tripDates: {
      ...
      label: '20–28 декабря 2027',
      priceSeason: 'новогодний пик: высокий чек не отменяет дефицит хороших номеров, депозитов и строгих условий отмены',
      selectionTrainingFocus: 'делать премиум-подборку с проверкой стройки, депозитов, пляжа, политики отмены и сезонной наценки'
    },
    clientProfile: {
  ...
  },
  {
    ...
    tripDates: {
      ...
      label: '5–12 января 2027',
      priceSeason: 'послепраздничный высокий спрос: мало времени, цены и наличие меняются быстро, условия оплаты жёстче',
      selectionTrainingFocus: 'быстро собрать безопасные альтернативы и честно объяснить, что горящий срок не отменяет проверку отеля'
    },
    clientProfile: {
